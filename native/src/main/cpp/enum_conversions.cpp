...
{
    jclass enumClass = env->FindClass("[Lcom/spireofbabel/raknet4j/RakNetEnums/StartupResult;");
    switch(result) {
        case RAKNET_STARTED:
        {
...
{
    jclass enumClass = env->FindClass("[Lcom/spireofbabel/raknet4j/RakNetEnums/ConnectionAttemptResult;");
    switch(result) {
...
{
    jclass enumClass = env->FindClass("[Lcom/spireofbabel/raknet4j/RakNetEnums/PacketPriority;");
...
{
    jclass enumClass = env->FindClass("[Lcom/spireofbabel/raknet4j/RakNetEnums/PacketReliability;");
    jmethodID getOrdinalMethod = env->GetMethodID(enumClass, "ordinal", "()I");
    jint value = env->CallIntMethod(enumObj, getOrdinalMethod);
